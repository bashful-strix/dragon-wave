...
" Last Updated: Sat 26 Aug 12:44:19 2023
...
let g:terminal_ansi_colors = ['#16161d', '#c34043', '#76946a', '#c0a36e', '#7e9cd8', '#957fb8', '#6a9589', '#c8c093', '#727169', '#e82424', '#98bb6c', '#e6c384', '#7fb4ca', '#938aa9', '#7aa89f', '#dcd7ba']
endif
if get(g:, '@kana_transp_bg', 0) && !has('gui_running')
hi Normal guifg=#dcd7ba guibg=#1f1f28 gui=NONE cterm=NONE
hi Terminal guifg=#dcd7ba guibg=#1f1f28 gui=NONE cterm=NONE
else
hi Normal guifg=#dcd7ba guibg=NONE gui=NONE cterm=NONE
hi Terminal guifg=#dcd7ba guibg=NONE gui=NONE cterm=NONE
endif
hi ColorColumn guifg=NONE guibg=#2a2a37 gui=NONE cterm=NONE
hi Conceal guifg=#938aa9 guibg=NONE gui=bold cterm=bold
hi Cursor guifg=#1f1f28 guibg=#dcd7ba gui=NONE cterm=NONE
hi CurSearch guifg=#dcd7ba guibg=#2d4f67 gui=bold cterm=bold
hi CursorLine guifg=NONE guibg=#363646 gui=NONE cterm=NONE
hi CursorLineNr guifg=#ff9e3b guibg=#2a2a37 gui=bold cterm=bold
...
hi FoldColumn guifg=#54546d guibg=#2a2a37 gui=NONE cterm=NONE
hi Folded guifg=#938aa9 guibg=#2a2a37 gui=NONE cterm=NONE
hi IncSearch guifg=#223249 guibg=#ff9e3b gui=NONE cterm=NONE
hi LineNr guifg=#54546d guibg=#2a2a37 gui=NONE cterm=NONE
...
hi NonText guifg=#54546d guibg=NONE gui=NONE cterm=NONE
...
hi SignColumn guifg=#938aa9 guibg=#2a2a37 gui=NONE cterm=NONE
...
hi StatusLine guifg=#c8c093 guibg=#16161d gui=NONE cterm=NONE
hi StatusLineNC guifg=#54546d guibg=#16161d gui=NONE cterm=NONE
hi TabLine guifg=#16161d guibg=#938aa9 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=#1f1f28 gui=NONE cterm=NONE
hi TabLineSel guifg=#c8c093 guibg=#2a2a37 gui=NONE cterm=NONE
...
hi debugBreakpoint guifg=#7fb4ca guibg=#2a2a37 gui=NONE cterm=NONE
hi debugPC guifg=NONE guibg=#43242b gui=NONE cterm=NONE
hi Boolean guifg=#ffa066 guibg=NONE gui=bold cterm=bold
hi Comment guifg=#727169 guibg=NONE gui=italic cterm=italic
hi Constant guifg=#ffa066 guibg=NONE gui=NONE cterm=NONE
hi Delimiter guifg=#9cabca guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#e82424 guibg=NONE gui=NONE cterm=NONE
hi Exception guifg=#e46876 guibg=NONE gui=NONE cterm=NONE
hi Function guifg=#7e9cd8 guibg=NONE gui=NONE cterm=NONE
hi Identifier guifg=#e6c384 guibg=NONE gui=NONE cterm=NONE
hi Keyword guifg=#957fb8 guibg=NONE gui=NONE cterm=NONE
hi Number guifg=#d27e99 guibg=NONE gui=NONE cterm=NONE
hi Operator guifg=#c0a36e guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#e46876 guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#98bb6c guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#957fb8 guibg=NONE gui=NONE cterm=NONE
...
hi FoldColumn ctermfg=60 ctermbg=236 cterm=NONE
hi Folded ctermfg=103 ctermbg=236 cterm=NONE
hi IncSearch ctermfg=236 ctermbg=215 cterm=NONE
hi LineNr ctermfg=60 ctermbg=236 cterm=NONE
...
hi SignColumn ctermfg=103 ctermbg=236 cterm=NONE
...
hi TabLine ctermfg=233 ctermbg=103 cterm=NONE
hi TabLineFill ctermfg=NONE ctermbg=234 cterm=NONE
hi TabLineSel ctermfg=144 ctermbg=236 cterm=NONE
...
hi debugBreakpoint ctermfg=74 ctermbg=236 cterm=NONE
hi debugPC ctermfg=NONE ctermbg=236 cterm=NONE
hi Boolean ctermfg=216 ctermbg=NONE cterm=bold
...
hi Keyword ctermfg=104 ctermbg=NONE cterm=NONE
...
hi Statement ctermfg=104 ctermbg=NONE cterm=NONE
...
" Term colors:         sumiInk0          autumnRed         autumnGreen
