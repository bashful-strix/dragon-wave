...
" Last Updated: Sun 27 Aug 16:29:43 2023
...
let g:terminal_ansi_colors = ['#0d0c0c', '#c4746e', '#8a9a7b', '#c4b28a', '#8ba4b0', '#a292a3', '#8ea4a2', '#c8c093', '#a6a69c', '#e46876', '#87a987', '#e6c384', '#7fb4ca', '#938aa9', '#7aa89f', '#c5c9c5']
endif
if get(g:, '@dragon_transp_bg', 0) && !has('gui_running')
hi Normal guifg=#c5c9c5 guibg=NONE gui=NONE cterm=NONE
hi Terminal guifg=#c5c9c5 guibg=NONE gui=NONE cterm=NONE
else
hi Normal guifg=#c5c9c5 guibg=#181616 gui=NONE cterm=NONE
hi Terminal guifg=#c5c9c5 guibg=#181616 gui=NONE cterm=NONE
endif
hi ColorColumn guifg=NONE guibg=#282727 gui=NONE cterm=NONE
hi Conceal guifg=#7a8382 guibg=NONE gui=bold cterm=bold
hi Cursor guifg=#181616 guibg=#c5c9c5 gui=NONE cterm=NONE
hi CurSearch guifg=#c5c9c5 guibg=#2d4f67 gui=bold cterm=bold
...
hi Directory guifg=#8ba4b0 guibg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#181616 guibg=NONE gui=NONE cterm=NONE
hi ErrorMsg guifg=#e82424 guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=#625e5a guibg=#282727 gui=NONE cterm=NONE
hi Folded guifg=#7a8382 guibg=#282727 gui=NONE cterm=NONE
hi IncSearch guifg=#223249 guibg=#ff9e3b gui=NONE cterm=NONE
hi LineNr guifg=#625e5a guibg=#282727 gui=NONE cterm=NONE
...
hi Search guifg=#c5c9c5 guibg=#2d4f67 gui=NONE cterm=NONE
hi SignColumn guifg=#7a8382 guibg=#282727 gui=NONE cterm=NONE
hi SpecialKey guifg=#7a8382 guibg=NONE gui=NONE cterm=NONE
...
hi StatusLine guifg=#c8c093 guibg=#0d0c0c gui=NONE cterm=NONE
hi StatusLineNC guifg=#625e5a guibg=#0d0c0c gui=NONE cterm=NONE
hi TabLine guifg=#7a8382 guibg=#0d0c0c gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=#181616 gui=NONE cterm=NONE
hi TabLineSel guifg=#c8c093 guibg=#282727 gui=NONE cterm=NONE
hi Title guifg=#7e9cd8 guibg=NONE gui=bold cterm=bold
hi VertSplit guifg=#16161d guibg=NONE gui=NONE cterm=NONE
hi Visual guifg=NONE guibg=#223249 gui=NONE cterm=NONE
hi WarningMsg guifg=#ff9e3b guibg=NONE gui=NONE cterm=NONE
hi debugBreakpoint guifg=#949fb5 guibg=#282727 gui=NONE cterm=NONE
hi debugPC guifg=NONE guibg=#43242b gui=NONE cterm=NONE
hi Boolean guifg=#b6927b guibg=NONE gui=bold cterm=bold
hi Comment guifg=#737c73 guibg=NONE gui=italic cterm=italic
hi Constant guifg=#b6927b guibg=NONE gui=NONE cterm=NONE
hi Delimiter guifg=#a6a69c guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#e82424 guibg=NONE gui=NONE cterm=NONE
hi Exception guifg=#c4746e guibg=NONE gui=NONE cterm=NONE
hi Function guifg=#8ba4b0 guibg=NONE gui=NONE cterm=NONE
hi Identifier guifg=#c4b28a guibg=NONE gui=NONE cterm=NONE
hi Keyword guifg=#8992a7 guibg=NONE gui=NONE cterm=NONE
hi Number guifg=#a292a3 guibg=NONE gui=NONE cterm=NONE
hi Operator guifg=#c4746e guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#c4746e guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#949fb5 guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#8992a7 guibg=NONE gui=NONE cterm=NONE
hi String guifg=#8a9a7b guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#223249 guibg=#658594 gui=bold cterm=bold
hi Type guifg=#8ea4a2 guibg=NONE gui=italic cterm=italic
hi Underlined guifg=#949fb5 guibg=NONE gui=underline cterm=underline
hi ToolbarLine guifg=NONE guibg=#181616 gui=NONE cterm=NONE
hi ToolbarButton guifg=#c5c9c5 guibg=#181616 gui=bold cterm=bold
if !s:italics
...
hi Terminal ctermfg=251 ctermbg=233 cterm=NONE
endif
hi ColorColumn ctermfg=NONE ctermbg=235 cterm=NONE
hi Conceal ctermfg=244 ctermbg=NONE cterm=bold
hi Cursor ctermfg=233 ctermbg=251 cterm=NONE
hi CurSearch ctermfg=251 ctermbg=24 cterm=bold
...
hi LineNr ctermfg=59 ctermbg=235 cterm=NONE
...
hi Search ctermfg=251 ctermbg=24 cterm=NONE
...
hi StatusLine ctermfg=144 ctermbg=232 cterm=NONE
hi StatusLineNC ctermfg=59 ctermbg=232 cterm=NONE
hi TabLine ctermfg=244 ctermbg=232 cterm=NONE
hi TabLineFill ctermfg=NONE ctermbg=233 cterm=NONE
hi TabLineSel ctermfg=144 ctermbg=235 cterm=NONE
...
hi debugBreakpoint ctermfg=110 ctermbg=235 cterm=NONE
hi debugPC ctermfg=NONE ctermbg=236 cterm=NONE
hi Boolean ctermfg=137 ctermbg=NONE cterm=bold
hi Comment ctermfg=243 ctermbg=NONE cterm=italic
hi Constant ctermfg=137 ctermbg=NONE cterm=NONE
hi Delimiter ctermfg=248 ctermbg=NONE cterm=NONE
...
hi ToolbarButton ctermfg=251 ctermbg=233 cterm=bold
if !s:italics
...
" Term colors:         dragonBlack0      dragonRed         dragonGreen2
" Term colors:         dragonYellow      dragonBlue2       dragonPink
" Term colors:         dragonAqua        oldWhite          dragonGray
" Term colors:         waveRed           dragonGreen       carpYellow
" Term colors:         springBlue        springViolet1     waveAqua2
" Term colors:         dragonWhite
