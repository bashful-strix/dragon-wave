...
" Last Updated: Sat 30 Mar 13:23:01 2024
...
" vim.api.nvim_set_hl(0, "@namespace", { link = "PreProc" })
" vim.api.nvim_set_hl(0, "@include", { link = "Include" })
" vim.api.nvim_set_hl(0, "@constant.builtin", { link = "Boolean" })
" vim.api.nvim_set_hl(0, "@parameter", { link = "Define" })
...
" vim.api.nvim_set_hl(0, "@variable.builtin", { link = "Macro" })
...
vim.api.nvim_set_hl(0, '@lsp.type.class.typescript', {})
